...
Remplacer la ligne 9 par une ligne vide, suivie du titre de section `# Exercice 4`, suivie par une ligne vide :
...
Dans l'en-tête du document, ajouter l'option `toc: TRUE` sous `html_document:`, puis réorganiser l'indentation comme illustré ci-bas. Attention! Les lignes 3 et 4 doivent se terminer par un `:` pour indiquer qu'une option de niveau inférieur les suit :
